...
class TrusteeIndividualPrintHelper @Inject()(answerRowConverter: AnswerRowConverter) {
  ...
  private def answers(userAnswers: UserAnswers, name: String, index: Int, draftId: String)
    ...
    Seq(
      ...
      bound.yesNoQuestion(mld5.CountryOfNationalityYesNoPage(index), s"$prefix.5mld.countryOfNationalityYesNo", mld5Rts.CountryOfNationalityYesNoController.onPageLoad(index, draftId).url),
      bound.yesNoQuestion(mld5.CountryOfNationalityInTheUkYesNoPage(index), s"$prefix.5mld.countryOfNationalityInTheUkYesNo",
        mld5Rts.CountryOfNationalityInTheUkYesNoController.onPageLoad(index, draftId).url),
      bound.countryQuestion(mld5.CountryOfNationalityInTheUkYesNoPage(index), mld5.CountryOfNationalityPage(index),
        s"$prefix.5mld.countryOfNationality", mld5Rts.CountryOfNationalityController.onPageLoad(index, draftId).url),
      ...
      bound.yesNoQuestion(mld5.CountryOfResidenceYesNoPage(index), s"$prefix.5mld.countryOfResidenceYesNo", mld5Rts.CountryOfResidenceYesNoController.onPageLoad(index, draftId).url),
      bound.yesNoQuestion(mld5.CountryOfResidenceInTheUkYesNoPage(index), s"$prefix.5mld.countryOfResidenceInTheUkYesNo",
      ...
      bound.countryQuestion(mld5.CountryOfResidenceInTheUkYesNoPage(index), mld5.CountryOfResidencePage(index),
        s"$prefix.5mld.countryOfResidence", mld5Rts.CountryOfResidenceController.onPageLoad(index, draftId).url),
      ...
      bound.enumQuestion(mld5.MentalCapacityYesNoPage(index), s"$prefix.5mld.mentalCapacityYesNo", mld5Rts.MentalCapacityYesNoController.onPageLoad(index, draftId).url, "site")
    ).flatten
