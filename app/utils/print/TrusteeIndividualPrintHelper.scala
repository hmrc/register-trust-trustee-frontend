...
class TrusteeIndividualPrintHelper @Inject()(answerRowConverter: AnswerRowConverter, countryOptions: CountryOptions) {
  ...
  private def answers(userAnswers: UserAnswers, name: String, index: Int, draftId: String)
    ...
    Seq(
      ...
      bound.yesNoQuestion(mld5.CountryOfResidencyYesNoPage(index), s"$prefix.5mld.countryOfResidencyYesNo", mld5Rts.CountryOfResidencyYesNoController.onPageLoad(index, draftId).url),
      bound.yesNoQuestion(mld5.CountryOfResidencyInTheUkYesNoPage(index), s"$prefix.5mld.countryOfResidencyInTheUkYesNo", mld5Rts.CountryOfResidencyInTheUkYesNoController.onPageLoad(index, draftId).url),
      bound.countryQuestion(mld5.CountryOfResidencyInTheUkYesNoPage(index), mld5.CountryOfResidencyPage(index), s"$prefix.5mld.countryOfResidency", mld5Rts.CountryOfResidencyController.onPageLoad(index, draftId).url),
