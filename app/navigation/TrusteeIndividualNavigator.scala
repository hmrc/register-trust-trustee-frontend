...
class TrusteeIndividualNavigator extends Navigator {
  ...
  override def conditionalNavigation(
    ...
    case page @ DateOfBirthYesNoPage(index)                 =>
      ua =>
        yesNoNav(
          ua = ua,
          fromPage = page,
    ...
    case page @ PassportDetailsYesNoPage(index)             =>
      ua =>
        yesNoNav(
          ua = ua,
          fromPage = page,
    ...
    case page @ IDCardDetailsYesNoPage(index)               =>
      ua =>
        yesNoNav(
          ua = ua,
          fromPage = page,
    ...
    case _ @MentalCapacityYesNoPage(index)                  => _ => CheckDetailsController.onPageLoad(index, draftId)
  }
