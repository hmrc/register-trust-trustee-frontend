...
import pages.register.leadtrustee.organisation.AddressUkYesNoPage
import play.api.data.Form
import play.api.i18n.{I18nSupport, MessagesApi}
import play.api.mvc.{Action, AnyContent, MessagesControllerComponents}
import repositories.RegistrationsRepository
import uk.gov.hmrc.play.bootstrap.controller.FrontendBaseController
import views.html.register.leadtrustee.organisation.AddressUkYesNoView
...
class AddressUkYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("leadTrustee.organisation.addressUkYesNo")
    ...
    implicit request =>
      ...
      form.bindFromRequest().fold(
        ...
        value => {
          ...
          } yield Redirect(navigator.nextPage(AddressUkYesNoPage, draftId, updatedAnswers))
        }
      )
  }
}
