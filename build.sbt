  ...
  .settings(
    ...
    Concat.groups := Seq(
      "javascripts/registertrusttrusteefrontend-app.js" ->
        group(Seq("javascripts/show-hide-content.js", "javascripts/registertrusttrusteefrontend.js"))
    ),
    ...
    includeFilter in uglify := GlobFilter("registertrusttrusteefrontend-*.js")
  )
