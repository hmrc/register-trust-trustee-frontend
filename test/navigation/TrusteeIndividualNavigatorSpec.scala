...
class TrusteeIndividualNavigatorSpec extends SpecBase with ScalaCheckPropertyChecks with Generators {
  ...
  "Trustee Individual Navigator" when {
    ...
    "none taxable with at least one trustee" must {
      ...
      "NamePage" when {
        "taxable=N -> DateOfBirthYesNoYesNoPage" in
          navigator
            .nextPage(NamePage(index), fakeDraftId, noneTaxableAnswers)
      ...
      "DateOfBirthYesNo" when {
        "taxable=N -> CountryOfNationalityYesNoPage when user answers No" in {
          ...
          navigator
            .nextPage(DateOfBirthYesNoPage(index), fakeDraftId, answers)
      ...
      "DateOfBirth" when {
        "taxable=N -> CountryOfNationalityYesNoPage" in
          navigator
            .nextPage(DateOfBirthPage(index), fakeDraftId, noneTaxableAnswers)
            .mustBe(CountryOfNationalityYesNoController.onPageLoad(index, fakeDraftId))
      }
      ...
      "CountryOfNationalityYesNoPage" must {
        "taxable=N -> CountryOfNationalityInTheUkYesNoPage when user answers yes" in {
          ...
          navigator
            .nextPage(CountryOfNationalityYesNoPage(index), fakeDraftId, answers)
      ...
      "CountryOfNationalityInTheUkYesNoPage" when {
        "taxable=N -> CountryOfNationalityYesNoPage when user answers no" in {
          ...
          navigator
            .nextPage(CountryOfNationalityInTheUkYesNoPage(index), fakeDraftId, answers)
      ...
      "CountryOfNationalityInTheUkYesNoPage" when {
        "taxable=N -> TrusteesNinoYesNo page" in
          navigator
            .nextPage(CountryOfNationalityPage(index), fakeDraftId, noneTaxableAnswers)
            .mustBe(CountryOfResidenceYesNoController.onPageLoad(index, fakeDraftId))
      }
      ...
      "CountryOfResidence" when {
        "taxable=N -> MentalCapacityPage" in
          navigator
            .nextPage(CountryOfResidencePage(index), fakeDraftId, noneTaxableAnswers)
            .mustBe(MentalCapacityYesNoController.onPageLoad(index, fakeDraftId))
      }
      ...
      "PassportDetailsPage" when {
        "taxable=N -> MentalCapacityPage" in
          navigator
            .nextPage(PassportDetailsPage(index), fakeDraftId, noneTaxableAnswers)
            .mustBe(MentalCapacityYesNoController.onPageLoad(index, fakeDraftId))
      }
      ...
      "UkAddressPage" when {
        "taxable=N -> PassportDetailsYesNoPage when answer is yes" in
          navigator
            .nextPage(UkAddressPage(index), fakeDraftId, noneTaxableAnswers)
      ...
      "InternationalAddressPage" when {
        "taxable=N -> PassportDetailsYesNoPage  when answer is yes" in
          navigator
            .nextPage(InternationalAddressPage(index), fakeDraftId, noneTaxableAnswers)
            .mustBe(PassportDetailsYesNoController.onPageLoad(index, fakeDraftId))
      }
      ...
      "PassportDetailsYesNoPage" when {
        "taxable=N -> PassportDetailsPage when answer is yes" in {
          ...
          navigator
            .nextPage(PassportDetailsYesNoPage(index), fakeDraftId, answers)
      ...
      "IDCardDetailsYesNoPage" when {
        "taxable=N -> IDCardDetailsPage when answer is yes" in {
          ...
          navigator
            .nextPage(IDCardDetailsYesNoPage(index), fakeDraftId, answers)
      ...
      "IdCardDetailsPage" when {
        "taxable=N -> MentalCapacityPage" in
          navigator
            .nextPage(IDCardDetailsPage(index), fakeDraftId, noneTaxableAnswers)
            .mustBe(MentalCapacityYesNoController.onPageLoad(index, fakeDraftId))
      }
      ...
      "LegallyIncapablePage" when {
        ...
        "taxable=N -> TrusteeAnswersPage when answer is yes" in {
          ...
          navigator
            .nextPage(MentalCapacityYesNoPage(index), fakeDraftId, answers)
        ...
        "taxable=N -> TrusteeAnswersPage when answer is don't know" in {
          val answers =
            noneTaxableAnswers.set(MentalCapacityYesNoPage(index), value = YesNoDontKnow.DontKnow).success.value
    ...
    "taxable with at least one trustee" must {
      ...
      val taxableAnswers5mldWithNoNino =
        emptyUserAnswers.copy(isTaxable = true).set(NinoYesNoPage(index), value = false).success.value

      "NamePage" when {
        "taxable=Y -> DateOfBirthYesNoYesNoPage" in
          navigator
            .nextPage(NamePage(index), fakeDraftId, taxableAnswers5mld)
            .mustBe(DateOfBirthYesNoController.onPageLoad(index, fakeDraftId))
      }
      ...
      "DateOfBirth" when {
        "taxable=Y -> CountryOfNationalityYesNoPage" in
          navigator
            .nextPage(DateOfBirthPage(index), fakeDraftId, taxableAnswers5mld)
            .mustBe(CountryOfNationalityYesNoController.onPageLoad(index, fakeDraftId))
      }
      ...
      "CountryOfNationalityInTheUkYesNoPage" when {
        "taxable=Y -> TrusteesNinoYesNo page" in
          navigator
            .nextPage(CountryOfNationalityPage(index), fakeDraftId, taxableAnswers5mld)
            .mustBe(NinoYesNoController.onPageLoad(index, fakeDraftId))
      }
      ...
      "NinoYesNoPage" when {
        "taxable=Y -> TrusteesNinoPage when user answers Yes" in {
          ...
          navigator
            .nextPage(NinoYesNoPage(index), fakeDraftId, answers)
      ...
      "TrusteesNinoPage" when {
        "taxable=Y -> CountryOfResidenceYesNoPage" in
          navigator
            .nextPage(NinoPage(index), fakeDraftId, taxableAnswers5mld)
            .mustBe(CountryOfResidenceYesNoController.onPageLoad(index, fakeDraftId))
      }
      ...
      "CountryOfResidenceYesNoPage" when {
        "taxable=Y -> MentalCapacityPage when the answer is no" in {
          val answers = taxableAnswers5mld
            .set(CountryOfResidenceYesNoPage(index), value = false)
            .success
            .value
      ...
      "CountryOfResidenceInTheUkYesNo" when {
        "taxable=Y -> MentalCapacityPage when the answer is yes" in {
          val answers = taxableAnswers5mld
            .set(CountryOfResidenceInTheUkYesNoPage(index), value = true)
            .success
            .value
      ...
      "CountryOfResidence" when {
        "taxable=Y -> MentalCapacityPage" in
          navigator
            .nextPage(CountryOfResidencePage(index), fakeDraftId, taxableAnswers5mld)
            .mustBe(MentalCapacityYesNoController.onPageLoad(index, fakeDraftId))

        "taxable=Y with no Nino-> AddressYesNo" in
          navigator
            .nextPage(CountryOfResidencePage(index), fakeDraftId, taxableAnswers5mldWithNoNino)
            .mustBe(AddressYesNoController.onPageLoad(index, fakeDraftId))
      }
      ...
      "PassportDetailsPage" when {
        "taxable=Y -> MentalCapacityPage" in
          navigator
            .nextPage(PassportDetailsPage(index), fakeDraftId, taxableAnswers5mld)
            .mustBe(MentalCapacityYesNoController.onPageLoad(index, fakeDraftId))
      }
      ...
      "UkAddressPage" when {
        "taxable=Y -> PassportDetailsYesNoPage when answer is yes" in
          navigator
            .nextPage(UkAddressPage(index), fakeDraftId, taxableAnswers5mld)
            .mustBe(PassportDetailsYesNoController.onPageLoad(index, fakeDraftId))
      }
      ...
      "InternationalAddressPage" when {
        "taxable=Y -> PassportDetailsYesNoPage  when answer is yes" in
          navigator
            .nextPage(InternationalAddressPage(index), fakeDraftId, taxableAnswers5mld)
            .mustBe(PassportDetailsYesNoController.onPageLoad(index, fakeDraftId))
      }
      ...
      "IdCardDetailsPage" when {
        "taxable=Y -> MentalCapacityPage" in
          navigator
            .nextPage(IDCardDetailsPage(index), fakeDraftId, taxableAnswers5mld)
            .mustBe(MentalCapacityYesNoController.onPageLoad(index, fakeDraftId))
      }
