  ...
  "LeadTrusteeIndividual Navigator" must {
    ...
    "name page -> Name -> DOB page" in {
      val answers = emptyUserAnswers
        .set(TrusteesNamePage(index), FullName("First", None, "Last"))
        .success
        .value

      navigator
        .nextPage(TrusteesNamePage(index), fakeDraftId, answers)
        .mustBe(rts.DateOfBirthController.onPageLoad(index, fakeDraftId))
    }

    "Date Of Birth page -> Country Of Nationality UK yes no page" in
      navigator
        .nextPage(TrusteesDateOfBirthPage(index), fakeDraftId, emptyUserAnswers)
    ...
    "Country Of Nationality UK yes no page -> No -> Country of Nationality page" in {
      val answers = emptyUserAnswers
        .set(CountryOfNationalityInTheUkYesNoPage(index), false)
        .success
        .value
    ...
    "Country Of Nationality UK yes no page -> Yes -> Do You Know NINO page" in {
      val answers = emptyUserAnswers
        .set(CountryOfNationalityInTheUkYesNoPage(index), true)
        .success
        .value
    ...
    "Country Of Nationality page -> Do You Know NINO page" in
      navigator
        .nextPage(CountryOfNationalityPage(index), fakeDraftId, emptyUserAnswers)
        .mustBe(rts.NinoYesNoController.onPageLoad(index, fakeDraftId))
    ...
    "NinoYesNo -> Yes -> Nino page" in {
      ...
      navigator
        .nextPage(TrusteeNinoYesNoPage(index), fakeDraftId, answers)
        .mustBe(rts.NinoController.onPageLoad(index, fakeDraftId))
    }

    "NINO page -> Country Of Residence UK yes no page" in
      navigator
        .nextPage(TrusteesNinoPage(index), fakeDraftId, emptyUserAnswers)
    ...
    "TrusteeDetailsChoice Page -> IdCard -> IDCard page" in {
      ...
      navigator
        .nextPage(TrusteeDetailsChoicePage(index), fakeDraftId, answers)
    ...
    "IDCard Page -> IDCard -> Country Of Residence UK yes no Page" in {
      val answers = emptyUserAnswers
        .set(IDCardDetailsPage(index), PassportOrIdCardDetails("UK", "0987654321234", LocalDate.now()))
        .success
        .value

      navigator
        .nextPage(IDCardDetailsPage(index), fakeDraftId, answers)
        .mustBe(mld5Rts.CountryOfResidenceInTheUkYesNoController.onPageLoad(index, fakeDraftId))
    }

    "Passport Page -> Passport -> Country Of Residence UK yes no Page" in {
      val answers = emptyUserAnswers
        .set(PassportDetailsPage(index), PassportOrIdCardDetails("UK", "0987654321234", LocalDate.now()))
        .success
        .value

      navigator
        .nextPage(PassportDetailsPage(index), fakeDraftId, answers)
        .mustBe(mld5Rts.CountryOfResidenceInTheUkYesNoController.onPageLoad(index, fakeDraftId))
    }
    ...
    "UkAddress Page -> UkAddress -> emailYesNo Page" in {
      val answers = emptyUserAnswers
        .set(UkAddressPage(index), UKAddress("value 1", "value 2", Some("value 3"), Some("value 4"), "AB1 1AB"))
        .success
        .value

      navigator
        .nextPage(UkAddressPage(index), fakeDraftId, answers)
    ...
    "InternationalAddress Page -> InternationalAddress -> emailYesNo Page" in {
      val answers = emptyUserAnswers
        .set(InternationalAddressPage(index), InternationalAddress("line 1", "line 2", Some("line 3"), "country"))
        .success
        .value

      navigator
        .nextPage(InternationalAddressPage(index), fakeDraftId, answers)
        .mustBe(rts.EmailAddressYesNoController.onPageLoad(index, fakeDraftId))
    }
    ...
    "emailYesNo Page -> Yes -> email Page" in {
      ...
      navigator
        .nextPage(EmailAddressYesNoPage(index), fakeDraftId, answers)
    ...
    "email Page -> emailaddress -> TelephoneNumber Page" in {
      val answers = emptyUserAnswers
        .set(EmailAddressPage(index), "test@test.com")
        .success
        .value

      navigator
        .nextPage(EmailAddressPage(index), fakeDraftId, answers)
        .mustBe(rts.TelephoneNumberController.onPageLoad(index, fakeDraftId))
    }

    "TelephoneNumber Page -> TelephoneNumber -> CheckDetails Page" in {
      val answers = emptyUserAnswers
        .set(TelephoneNumberPage(index), "123456789")
        .success
        .value

      navigator
        .nextPage(TelephoneNumberPage(index), fakeDraftId, answers)
