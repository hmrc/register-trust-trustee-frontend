...
class CorrespondenceMapperSpec extends SpecBase with Matchers with OptionValues with Generators {
      ...
      "for a UK lead trustee individual" must {
        ...
        "not be able to create correspondence pieces when do not have all answers" in {
          val userAnswers = emptyUserAnswers
            ...
            .success
            .value
            .set(ltind.TrusteesNamePage(0), FullName("First", None, "Last"))
            .success
            .value
        ...
        "be able to create a correspondence when have all required answers" in {
          ...
          val userAnswers = emptyUserAnswers
            ...
            .success
            .value
            .set(ltind.TrusteesDateOfBirthPage(0), LocalDate.of(2010, 10, 10))
            .success
            .value
            ...
            .success
            .value
            .set(ltind.UkAddressPage(0), address)
            .success
            .value
            .set(ltind.EmailAddressYesNoPage(0), false)
            .success
            .value
            .set(ltind.TelephoneNumberPage(0), "0191 222222")
            .success
            .value
      ...
      "for a UK lead trustee organisation" must {
        ...
        "be able to create a correspondence when have all required answers" in {
          ...
          val userAnswers = emptyUserAnswers
            ...
            .success
            .value
            .set(ltorg.UtrPage(0), "1234567890")
            .success
            .value
            .set(ltorg.AddressUkYesNoPage(0), true)
            .success
            .value
            .set(ltorg.UkAddressPage(0), address)
            .success
            .value
            .set(ltorg.EmailAddressYesNoPage(0), false)
            .success
            .value
            .set(ltorg.TelephoneNumberPage(0), "0191 222222")
            .success
            .value
      ...
      "for a Non-UK lead trustee organisation" must {
        ...
        "be able to create a correspondence when have all required answers" in {
          ...
          val userAnswers = emptyUserAnswers
            ...
            .success
            .value
            .set(ltorg.InternationalAddressPage(0), address)
            .success
            .value
            .set(ltorg.EmailAddressYesNoPage(0), false)
            .success
