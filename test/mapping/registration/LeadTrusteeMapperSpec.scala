...
import models.{
  AddressType, IdentificationOrgType, IdentificationType, LeadTrusteeIndType, LeadTrusteeOrgType, LeadTrusteeType,
  PassportType
}
...
class LeadTrusteeMapperSpec extends SpecBase with Matchers with OptionValues with Generators {
      ...
      "mapping a lead trustee individual" must {
        ...
        "create LeadTrusteeType for lead trustee individual with nino" in {
          ...
          val userAnswers = emptyUserAnswers
            ...
            .success
            .value
            .set(ltind.TrusteesDateOfBirthPage(index), LocalDate.of(1500, 10, 10))
            .success
            .value
        ...
        "create LeadTrusteeType for lead trustee individual with passport, address and email" in {
          ...
          val index       = 0
          val userAnswers = emptyUserAnswers
            .set(register.TrusteeOrLeadTrusteePage(index), LeadTrustee)
            .success
            .value
            .set(register.TrusteeIndividualOrBusinessPage(index), IndividualOrBusiness.Individual)
            .success
            .value
            .set(ltind.TrusteesNamePage(index), FullName("first name", Some("middle name"), "Last Name"))
            .success
            ...
            .success
            .value
            .set(ltind.mld5.CountryOfNationalityInTheUkYesNoPage(index), true)
            .success
            .value
            .set(ltind.TrusteeNinoYesNoPage(index), false)
            .success
            .value
            .set(ltind.mld5.CountryOfResidenceInTheUkYesNoPage(index), true)
            .success
            .value
            .set(ltind.TrusteeDetailsChoicePage(index), DetailsChoice.Passport)
            .success
            .value
            .set(ltind.PassportDetailsPage(index), PassportOrIdCardDetails("FR", "number", LocalDate.of(1500, 10, 10)))
            .success
            .value
            .set(ltind.AddressUkYesNoPage(index), true)
            .success
            ...
            .success
            .value
            .set(ltind.EmailAddressYesNoPage(index), true)
            .success
            .value
            .set(ltind.EmailAddressPage(index), "adam@test.com")
            .success
            .value
            .set(ltind.TelephoneNumberPage(index), "0191 1111111")
            .success
        ...
        "create LeadTrusteeType for lead trustee individual with id card, address and email" in {
          ...
          val userAnswers = emptyUserAnswers
            ...
            .success
            .value
            .set(ltind.mld5.CountryOfNationalityPage(index), "DE")
            .success
            .value
            .set(ltind.TrusteeNinoYesNoPage(index), false)
            .success
            ...
            .success
            .value
            .set(ltind.mld5.CountryOfResidencePage(index), "DE")
            .success
            .value
            .set(ltind.TrusteeDetailsChoicePage(index), DetailsChoice.Passport)
            .success
            .value
            .set(ltind.PassportDetailsPage(index), PassportOrIdCardDetails("DE", "number", LocalDate.of(1500, 10, 10)))
            .success
            .value
            .set(ltind.AddressUkYesNoPage(index), false)
            .success
            .value
            .set(ltind.InternationalAddressPage(index), InternationalAddress("line1", "line2", Some("line3"), "DE"))
            .success
            .value
            .set(ltind.EmailAddressYesNoPage(index), true)
            .success
        ...
        "not create LeadTrusteeType for not lead trustee" in {
          val index       = 0
          val userAnswers = emptyUserAnswers
            .set(register.TrusteeOrLeadTrusteePage(index), Trustee)
            .success
            .value
            .set(register.TrusteeIndividualOrBusinessPage(index), IndividualOrBusiness.Individual)
            .success
            .value
            .set(
              pages.register.trustees.individual.NamePage(index),
              FullName("first name", Some("middle name"), "Last Name")
            )
            .success
            .value
            .set(pages.register.trustees.individual.DateOfBirthPage(index), LocalDate.of(1500, 10, 10))
            .success
            .value
        ...
        "not create LeadTrusteeType without telephone number" in {
          ...
          val userAnswers = emptyUserAnswers
            ...
            .success
            .value
            .set(ltind.UkAddressPage(index), UKAddress("line1", "line2", None, Some("line4"), "NE65QA"))
            .success
            .value
      ...
      "mapping a lead trustee business" must {
        ...
        "be able to create LeadTrusteeType from UK registered business, UK address" in {
          ...
          val userAnswers = emptyUserAnswers
            ...
            .success
            .value
            .set(register.TrusteeIndividualOrBusinessPage(index), IndividualOrBusiness.Business)
            .success
            .value
            .set(ltorg.UkRegisteredYesNoPage(index), true)
            .success
            .value
            .set(ltorg.NamePage(index), "Org Name")
            .success
            .value
            .set(ltorg.UtrPage(index), "1234567890")
            .success
            .value
            .set(ltorg.mld5.CountryOfResidenceInTheUkYesNoPage(index), true)
            .success
            .value
            .set(ltorg.AddressUkYesNoPage(index), true)
            .success
            .value
            .set(ltorg.UkAddressPage(index), UKAddress("line1", "line2", None, None, "NE65QA"))
            .success
            .value
            .set(ltorg.TelephoneNumberPage(index), "0191 1111111")
            .success
            .value
        ...
        "be able to create LeadTrusteeType from UK registered business with non-uk address" in {
          ...
          val userAnswers = emptyUserAnswers
            ...
            .success
            .value
            .set(ltorg.AddressUkYesNoPage(index), false)
            .success
            .value
            .set(ltorg.InternationalAddressPage(index), InternationalAddress("line1", "line2", None, "FR"))
            .success
            .value
            .set(ltorg.TelephoneNumberPage(index), "0191 1111111")
            .success
        ...
        "be able to create LeadTrusteeType from Non-UK registered business with uk address and email" in {
          ...
          val userAnswers = emptyUserAnswers
            ...
            .success
            .value
            .set(ltorg.UkRegisteredYesNoPage(index), false)
            .success
            .value
            .set(ltorg.NamePage(index), "Org Name")
            .success
            ...
            .success
            .value
            .set(ltorg.EmailAddressPage(index), "adam@test.com")
            .success
            .value
        ...
        "be able to create LeadTrusteeType from Non-UK registered business with non-uk address" in {
          ...
          val userAnswers = emptyUserAnswers
            ...
            .success
            .value
            .set(ltorg.mld5.CountryOfResidencePage(index), "FR")
            .success
            .value
            .set(ltorg.AddressUkYesNoPage(index), false)
            .success
