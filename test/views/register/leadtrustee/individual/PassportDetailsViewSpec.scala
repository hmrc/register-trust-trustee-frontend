...
class PassportDetailsViewSpec extends QuestionViewBehaviours[PassportOrIdCardDetails] {
  ...
  val messageKeyPrefix = "leadTrustee.individual.passportDetails"

  val name: FullName = FullName("First", None, "last")

  lazy val form: Form[PassportOrIdCardDetails] =
    injector.instanceOf[PassportOrIdCardFormProvider].apply("leadTrustee.individual.passportDetails")
