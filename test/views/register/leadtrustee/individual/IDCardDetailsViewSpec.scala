...
class IDCardDetailsViewSpec extends QuestionViewBehaviours[PassportOrIdCardDetails] {
  ...
  lazy val form = injector.instanceOf[PassportOrIdCardFormProvider].apply("leadTrustee.individual.iDCardDetails")
  ...
  "IdCardDetails view" must {
    ...
    "fields" must {
      ...
      behave like pageWithPassportOrIDCardDetailsFields(
        ...
        applyView,
        messageKeyPrefix,
        controllers.register.leadtrustee.individual.routes.PassportDetailsController.onSubmit(0, "draftId").url,
