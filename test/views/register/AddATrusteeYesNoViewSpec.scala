...
import views.html.register.AddATrusteeYesNoView

class AddATrusteeYesNoViewSpec extends YesNoViewBehaviours {

  val prefix = "addATrusteeYesNo"

  val form: Form[Boolean] = new YesNoFormProvider().withPrefix(prefix)

  "AddATrusteeYesNoView View" must {
    ...
    behave like yesNoPage(form, applyView, prefix, None)
