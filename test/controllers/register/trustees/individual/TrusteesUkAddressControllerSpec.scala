...
class TrusteesUkAddressControllerSpec extends SpecBase with IndexValidation {
  ...
  lazy val trusteesUkAddressRoute: String = routes.TrusteesUkAddressController.onPageLoad(index, fakeDraftId).url
  ...
  "TrusteesUkAddress Controller" must {
    ...
    "for a GET" must {
      ...
      def getForIndex(index: Int) : FakeRequest[AnyContentAsEmpty.type] = {
        val route = routes.TrusteesUkAddressController.onPageLoad(index, fakeDraftId).url
    ...
    "for a POST" must {
      def postForIndex(index: Int): FakeRequest[AnyContentAsFormUrlEncoded] = {
        ...
        val route =
          routes.TrusteesUkAddressController.onPageLoad(index, fakeDraftId).url
