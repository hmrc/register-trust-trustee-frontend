  ...
  "InternationalAddress Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      contentAsString(result) mustEqual
        view(form, countryOptions, fakeDraftId, index, fakeName.toString)(request, messages).toString
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      contentAsString(result) mustEqual
        view(form.fill(validAnswer), countryOptions, fakeDraftId, index, fakeName.toString)(request, messages).toString
    ...
    "return a Bad Request and errors when invalid data is submitted" in {
      ...
      contentAsString(result) mustEqual
        view(boundForm, countryOptions, fakeDraftId, index, fakeName.toString)(request, messages).toString
