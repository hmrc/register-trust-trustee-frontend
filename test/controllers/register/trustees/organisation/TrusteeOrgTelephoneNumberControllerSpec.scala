...
class TrusteeOrgTelephoneNumberControllerSpec extends SpecBase with IndexValidation {
  ...
  lazy val telephoneNumberRoute = routes.TrusteeOrgTelephoneNumberController.onPageLoad(index, fakeDraftId).url
  ...
  "for a GET" must {
    ...
    def getForIndex(index: Int): FakeRequest[AnyContentAsEmpty.type] = {
      val route = routes.TrusteeOrgTelephoneNumberController.onPageLoad(index, fakeDraftId).url
  ...
  "for a POST" must {
    def postForIndex(index: Int): FakeRequest[AnyContentAsFormUrlEncoded] = {
      ...
      val route =
        routes.TrusteeOrgTelephoneNumberController.onPageLoad(index, fakeDraftId).url
