...
package controllers.register.leadtrustee
...
import views.html.register.leadtrustee.IndividualOrBusinessView

class IndividualOrBusinessControllerSpec extends SpecBase with IndexValidation {

  lazy val individualOrBusinessRoute: String = routes.IndividualOrBusinessController.onPageLoad(fakeDraftId).url

  val formProvider = new TrusteeIndividualOrBusinessFormProvider()
  val form: Form[IndividualOrBusiness] = formProvider("leadTrustee.organisation.individualOrBusiness")
  ...
  "IndividualOrBusiness Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers
        .set(IndividualOrBusinessPage, IndividualOrBusiness.values.head).success.value
      ...
      contentAsString(result) mustEqual
        view(form.fill(IndividualOrBusiness.values.head), fakeDraftId)(fakeRequest, messages).toString
