    ...
    "render a print section" when {
      ...
      "trustee has no date of birth, NINO or address" in {
        val userAnswers: UserAnswers = baseAnswers
          .set(DateOfBirthYesNoPage(index), false)
          .success
          .value
        ...
        result mustBe AnswerSection(
          ...
          Seq(
            ...
            AnswerRow(
              "trustee.individual.dateOfBirthYesNo.checkYourAnswersLabel",
              Html("No"),
            ...
            AnswerRow(
              ...
              Html("No"),
              Some(NinoYesNoController.onPageLoad(index, fakeDraftId).url),
              displayName
            ),
            AnswerRow(
              "trustee.individual.addressYesNo.checkYourAnswersLabel",
              Html("No"),
        ...
        result mustBe AnswerSection(
          ...
          Seq(
            ...
            AnswerRow(
              ...
              Html("AA 00 00 00 A"),
              Some(NinoController.onPageLoad(index, fakeDraftId).url),
              displayName
            )
          )
        )
        ...
        result mustBe AnswerSection(
          ...
          Seq(
            ...
            AnswerRow(
              ...
              Html("Germany<br />1234567890<br />3 February 1996"),
      ...
      "trustee has country of residence" in {
        val userAnswers: UserAnswers = baseAnswers
          ...
          .success
          .value
          .set(CountryOfResidencePage(index), "ES")
          .success
          .value
        ...
        result mustBe AnswerSection(
          ...
          Seq(
            ...
            AnswerRow(
              "trustee.individual.5mld.countryOfResidenceYesNo.checkYourAnswersLabel",
              Html("Yes"),
              Some(CountryOfResidenceYesNoController.onPageLoad(index, fakeDraftId).url),
              displayName
            ),
            AnswerRow(
              "trustee.individual.5mld.countryOfResidenceInTheUkYesNo.checkYourAnswersLabel",
              Html("No"),
              Some(CountryOfResidenceInTheUkYesNoController.onPageLoad(index, fakeDraftId).url),
              displayName
            ),
            AnswerRow(
              "trustee.individual.5mld.countryOfResidence.checkYourAnswersLabel",
              Html("Spain"),
      ...
      "trustee has country of nationality" in {
        val userAnswers: UserAnswers = baseAnswers
          ...
          .success
          .value
          .set(CountryOfNationalityPage(index), "US")
          .success
          .value
        ...
        result mustBe AnswerSection(
          ...
          Seq(
            ...
            AnswerRow(
              "trustee.individual.5mld.countryOfNationalityYesNo.checkYourAnswersLabel",
              Html("Yes"),
              Some(CountryOfNationalityYesNoController.onPageLoad(index, fakeDraftId).url),
              displayName
            ),
            AnswerRow(
              "trustee.individual.5mld.countryOfNationalityInTheUkYesNo.checkYourAnswersLabel",
              Html("No"),
              Some(CountryOfNationalityInTheUkYesNoController.onPageLoad(index, fakeDraftId).url),
              displayName
            ),
            AnswerRow(
              "trustee.individual.5mld.countryOfNationality.checkYourAnswersLabel",
              Html("United States of America"),
              Some(CountryOfNationalityController.onPageLoad(index, fakeDraftId).url),
              displayName
            )
          )
        )
        ...
        result mustBe AnswerSection(
          ...
          Seq(
            ...
            AnswerRow(
              ...
              Html("Yes"),
              Some(MentalCapacityYesNoController.onPageLoad(index, fakeDraftId).url),
              displayName
            )
          )
        )
      ...
      "trustee has international address and ID card details" in {
        ...
        result mustBe AnswerSection(
          ...
          Seq(
            ...
            AnswerRow(
              "trustee.individual.internationalAddress.checkYourAnswersLabel",
